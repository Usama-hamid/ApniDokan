            ...
            <div class="col-lg-6 mb-3 mb-lg-0">
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3 flex-1">
                  <div class="fs-10px fw-bold text-white text-opacity-50 mb-1">
                    DISK USAGE
                  </div>
                  ...
                  <div class="d-flex align-items-center small">
                    <i
                      class="bi bi-circle-fill fs-6px me-2 text-theme text-opacity-50"
                    ></i>
                    ...
                    <div class="d-flex">
                      <div class="position-relative mb-2">
                        <div
                          ...
                          style="
                            background-image: url(../assets/img/dashboard/product-1.jpeg);
                          "
                        ></div>
                      ...
                      <div class="flex-1 ps-3">
                        <div class="mb-1">
                          <small
                            class="fs-9px fw-500 lh-1 d-inline-block rounded-0 badge bg-white bg-opacity-25 text-white text-opacity-75 pt-5px"
                            >SKU90400</small
                          >
                        </div>
                    ...
                    <div class="d-flex mb-2 align-items-center">
                      <div class="position-relative">
                        <div
                          class="bg-center bg-cover bg-no-repeat w-80px h-60px"
                          style="
                            background-image: url(../assets/img/dashboard/product-2.jpeg);
                          "
                        ></div>
                        <div class="position-absolute top-0 start-0">
                          <span
                    ...
                    <div class="d-flex mb-2 align-items-center">
                      <div class="position-relative">
                        <div
                          class="bg-center bg-cover bg-no-repeat w-80px h-60px"
                          style="
                            background-image: url(../assets/img/dashboard/product-3.jpeg);
                          "
                        ></div>
                        <div class="position-absolute top-0 start-0">
                          <span
                    ...
                    <div class="d-flex mb-2 align-items-center">
                      <div class="position-relative">
                        <div
                          class="bg-center bg-cover bg-no-repeat w-80px h-60px"
                          style="
                            background-image: url(../assets/img/dashboard/product-4.jpeg);
                          "
                        ></div>
                        <div class="position-absolute top-0 start-0">
                          <span
                            class="badge bg-black bg-opacity-50 rounded-0 d-flex align-items-center justify-content-center w-20px h-20px"
                            >4</span
                          >
                        </div>
                      </div>
                    ...
                    <div class="d-flex align-items-center">
                      <div class="position-relative">
                        <div
                          class="bg-center bg-cover bg-no-repeat w-80px h-60px"
                          style="
                            background-image: url(../assets/img/dashboard/product-5.jpeg);
                          "
                        ></div>
                        <div class="position-absolute top-0 start-0">
                          <span
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <span class="d-flex align-items-center">
                      <i
                        class="bi bi-circle-fill fs-6px text-white-transparent-3 me-2"
                      ></i>
                      Firewall upgrade
                    </span>
                  </td>
                  ...
                  <td>
                    <span
                      class="badge d-block bg-white bg-opacity-25 rounded-0 pt-5px w-70px"
                      style="min-height: 18px"
                      >SERVER</span
                    >
                  </td>
                ...
                <tr>
                  <td>
                    <span class="d-flex align-items-center">
                      <i
                        class="bi bi-circle-fill fs-6px text-white text-opacity-25 me-2"
                      ></i>
                      2 Unread enquiry
                    </span>
                  </td>
    ...
    getAnswer: function () {
      ...
      axios
        ...
        .then(function (response) {
          vm.answer = _.capitalize(response.data.forced);
        })
