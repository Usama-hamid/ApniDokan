            ...
            <div class="menu-item dropdown dropdown-mobile-full">
                <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
                    ...
                    <!-- <div class="menu-text d-sm-block d-none"><span class="__cf_email__"
                            data-cfemail="dfaaacbaadb1beb2ba9fbebcbcb0aab1abf1bcb0b2">[email&#160;protected]</span>
                    </div> -->
                </a>
                <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="settings.html">SETTINGS
                        <i class="bi bi-gear ms-auto text-theme fs-16px my-n1"></i></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item d-flex align-items-center" href="page_login.html">LOGOUT <i
